...
class Ship:
    ...
    def update(self):
        ...
        self.vel[0] = (self.vel[0] + self.thrust * angle_to_vector(self.angle)[0]) * ( 1 - friction)
        self.vel[1] = (self.vel[1] + self.thrust * angle_to_vector(self.angle)[1]) * ( 1 - friction)
        self.angle += self.angle_vel
        
    def rotate(self, delta_vel):
        self.angle_vel += delta_vel
      
    def flip_thrust(self):
